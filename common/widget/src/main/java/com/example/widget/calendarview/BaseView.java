...
//        mSchemeTextPaint.setStyle(Paint.Style.FILL);
        ...
        mSchemeTextPaint.setColor(Color.parseColor("#5C5C5C"));
...
//        mSchemePaint.setStrokeWidth(2);
        ...
        mCurDayTextPaint.setColor(Color.parseColor("#2E7DE0"));
//        mCurDayTextPaint.setFakeBoldText(true);
        ...
        mCurDayLunarTextPaint.setColor(Color.parseColor("#2E7DE0"));
