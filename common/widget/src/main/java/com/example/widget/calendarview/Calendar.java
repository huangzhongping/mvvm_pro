...
public final class Calendar implements Serializable {
    ...
    private boolean dateGray;//是否是灰色
    ...
    public boolean isDateGray() {
        return dateGray;
    }

    public void setDateGray(boolean dateGray) {
        this.dateGray = dateGray;
    }
    ...
    public final static class Scheme implements Serializable {
        ...
        public boolean isDataGray() {
            return dataGray;
        }

        public void setDataGray(boolean dataGray) {
            this.dataGray = dataGray;
        }

        public Scheme() {
        }
        public Scheme(boolean dataGray) {
            this.dataGray
                     = dataGray;
        }
