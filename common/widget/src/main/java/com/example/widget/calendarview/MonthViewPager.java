    ...
    private void init() {
        ...
        addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                mPosition = position;
                //滑动过程更新高度 ivan huang add 18/10/29
                Calendar calendar = CalendarUtil.getFirstCalendarFromMonthViewPager(mPosition, mDelegate);
...
//                mDelegate.mIndexCalendar = calendar;
                        ...
                        //为了避免每次都选中当前的或者1号 hide ivan huang 18/10/29
...
//                mDelegate.updateSelectCalendarScheme();
                        ...
                        BaseMonthView view = (BaseMonthView) findViewWithTag(mPosition);
                        if (view != null) {
    ...
    void scrollToCalendar(int year, int month, int day, boolean smoothScroll) {
        ...
        //为了scroll不默认选中 hide ivan huang 18/10/29
//        mDelegate.mIndexCalendar = calendar;
//        mDelegate.mSelectedCalendar = calendar;
//        mDelegate.updateSelectCalendarScheme();
        int y = calendar.getYear() - mDelegate.getMinYear();
