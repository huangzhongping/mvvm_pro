...
import com.example.widget.album.Filter;
import com.example.widget.R;
import com.example.widget.album.api.widget.Widget;
import com.example.widget.album.app.Contract;
import com.example.widget.album.app.album.data.MediaReadTask;
import com.example.widget.album.app.album.data.MediaReader;
import com.example.widget.album.app.album.data.PathConversion;
import com.example.widget.album.app.album.data.PathConvertTask;
import com.example.widget.album.app.album.data.ThumbnailBuildTask;
import com.example.widget.album.impl.OnItemClickListener;
import com.example.widget.album.mvp.BaseActivity;
import com.example.widget.album.util.AlbumUtils;
import com.example.widget.album.widget.LoadingDialog;
